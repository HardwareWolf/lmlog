...
from ..intelligence.aggregation import SmartAggregator, AggregatedEvent
from ..intelligence.cost_aware import CostAwareLogger, CostBudget, CostMetrics
...
class LMLogger(LLMLogger):
    ...
    def __init__(
        ...
        self._aggregator: Optional[SmartAggregator] = None
    ...
    def _write_aggregated_event(self, aggregated: AggregatedEvent) -> None:
